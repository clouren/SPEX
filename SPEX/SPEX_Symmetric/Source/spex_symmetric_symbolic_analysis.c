//------------------------------------------------------------------------------
// SPEX_Symmetric/spex_symmetric_symbolic_analysis: Symbolic analysis for
// Cholesky/LDL
// ------------------------------------------------------------------------------
 ...
 *
 * S:           Symbolic analysis struct for Cholesky/LDL factorization.
 *              On input it contains information that is not used in this
 *              function such as the row/column permutation On output it
 *              contains the elimination tree and the number of nonzeros in L.
 *
