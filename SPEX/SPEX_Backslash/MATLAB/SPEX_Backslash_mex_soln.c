...
/* Purpose: The .c file defining the SPEX Backslash MATLAB interfacee
...
)
{
    ...
    {
        spex_backslash_mex_error (1, "second input must be full") ;
    }
    ...
    if (nargin > 2) spex_backslash_get_matlab_options (option, &mexoptions, pargin [2]) ;
