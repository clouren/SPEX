...
// Rights Reserved.  SPDX-License-Identifier: GPL-2.0-or-later or
// LGPL-3.0-or-later
...
//
//    Christopher Lourenco, Jinhao Chen, Lorena Mejia Domenzain, Erick
//    Moreno-Centeno, and Timothy Davis
//
