...
def backslash( A, b, options={'SolutionType': 'double', 'Ordering': 'colamd'}): 
    ...
    x=spex_left_lu_backslash(A,b,order,charOut)

    return x

def spex_left_lu_backslash( A, b, order, charOut ): 
    ...
    c_backslash = lib.spex_left_lu_python
