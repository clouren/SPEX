...
\begin{center}
\begin{large}
\textbf{User Guide for SPEX Left LU, A Sparse Exact Left-Looking LU Factorization} \\
\vspace{5mm}
Version 1.0.1, January 2021 % VERSION
\vspace{20mm}
...
Using the SPEX matrix copy function, any matrix in any of the 15 combinations
...
\url{www.suitesparse.com} %TODO get correct link
...
program, precede your code with \verb|#include "SPEX_Left_LU.h"|.
...
\verb|SPEX_Left_LU_install|. This should compile the necessary code so that you can use
the \verb|SPEX_Left_LU_backslash| function from within MATLAB. Note that
\verb|SPEX_Left_LU_install| does not add the correct directory to your path; therefore,
...
%-------------------------------------------------------------------------------
\section{Managing the SPEX Left LU environment} \label{s:user:setup}
%-------------------------------------------------------------------------------

%-------------------------------------------------------------------------------
\cprotect\subsection{\verb|SPEX_Left_LU_VERSION|: the software package version}
%-------------------------------------------------------------------------------
...
%-------------------------------------------------------------------------------
\cprotect\subsection{\verb|SPEX_LU_analysis| structure}
...
\verb|SPEX/SPEX/SPEX_Left_LU/Demo| \verb|/example2.c| on how to read in data and construct
...
to $Ax=b$ using the simple interface of SPEX, \verb|SPEX_Left_LU_backslash|.  The
\verb|SPEX_Left_LU_backslash| function can return \verb|x| as \verb|double|,
