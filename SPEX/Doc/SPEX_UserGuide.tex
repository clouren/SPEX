...
Returns -1 if SPEX has not been initialized.
...
The symbolic analysis phase of SPEX Left LU computes the column permutation and
...
%-------------------------------------------------------------------------------
\cprotect\subsection{Examples of using SPEX Left LU in a C program}
