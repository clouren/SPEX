...
Macro & purpose \\
\hline
\verb|SPEX_LU_VERSION|       & current version of the code (as a string)\\
\verb|SPEX_LU_VERSION_MAJOR| & major version of the code\\
\verb|SPEX_LU_VERSION_MINOR| & minor version of the code   \\
\verb|SPEX_LU_VERSION_SUB|   & sub version of the code\\
\hline
\end{tabular}
\end{center}
