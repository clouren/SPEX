...
%----------------------------------------
{\small\begin{center}\begin{tabular}{llp{4in}}\hline
...
the tolerance-based pivoting scheme, i.e., \newline \verb|SPEX_TOL_SMALLEST| or
