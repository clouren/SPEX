//------------------------------------------------------------------------------
// SPEX/MATLAB/spex_qr_mex_soln: Use SPEX QR within MATLAB
//------------------------------------------------------------------------------
...
)
{
    ...
    {
        spex_mex_error (1, "Usage: x = SPEX_qr_soln (A,b,option)");
    }
...
/**/
    ...
    SPEX_matrix x = NULL ;
    SPEX_MEX_OK (SPEX_qr_backslash (&x, SPEX_MPQ, A, b, option));
