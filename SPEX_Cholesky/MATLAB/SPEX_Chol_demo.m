%% SPEX_Chol_DEMO a demo of SPEX_Chol_backslash
...
%
% See also vpa, SPEX_Left_LU_backslash
%
...
%% SPEX_Chol_backslash vs MATLAB backslash: first example
...
%% SPEX_Chol_backslash: exact, vs MATLAB backslash: approximate
...
% x = SPEX_C_backslash (A,b) is able to solve problems that x=A\b cannot.
% Consider the following matrix in the MATLAB gallery:
% TODO FIND A MATRIX FOR THIS TEST
%[U, b] = gallery ('wilk', 3)
...
%% SPEX_Chol_backslash with exact results
% SPEX_Chol_backslash can also return x as a cell array of strings, which
