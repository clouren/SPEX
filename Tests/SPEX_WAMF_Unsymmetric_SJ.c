 ...
 * with COLAMD vs SPEX Left LU with WAMF on SJ Database matrices. 
 * A similar file exists for BasisLIB matrices and 
...
int main( int argc, char* argv[] )
{
    ...
    char* mat_name = "315.mat"; // Set demo matrix and RHS name
    char* rhs_name = "315.mat.rhs";
    int64_t rat = 1;
